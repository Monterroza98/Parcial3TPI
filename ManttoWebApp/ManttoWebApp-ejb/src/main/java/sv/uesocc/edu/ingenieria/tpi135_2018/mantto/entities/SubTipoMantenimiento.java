...
@NamedQueries({
    ...
    , @NamedQuery(name = "SubTipoMantenimiento.findByNombreLike", query = "SELECT a FROM SubTipoMantenimiento a WHERE LOWER(a.nombre) LIKE CONCAT('%',LOWER(:name),'%')")
...
public class SubTipoMantenimiento implements Serializable {
    ...
    public String toString() {
        return "sv.uesocc.edu.ingenieria.tpi135_2018.mantto.SubTipoMantenimiento[ idSubTipoMantenimiento=" + idSubTipoMantenimiento + " ]";
    }

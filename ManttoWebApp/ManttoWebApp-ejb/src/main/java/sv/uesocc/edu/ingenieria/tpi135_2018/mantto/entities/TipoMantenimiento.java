...
@NamedQueries({
    ...
    , @NamedQuery(name = "TipoMantenimiento.findByNombreLike", query = "SELECT a FROM TipoMantenimiento a WHERE LOWER(a.nombre) LIKE CONCAT('%',LOWER(:name),'%')")
...
public class TipoMantenimiento implements Serializable {
    ...
    public String toString() {
        return "sv.uesocc.edu.ingenieria.tpi135_2018.mantto.TipoMantenimiento[ idTipoMantenimiento=" + idTipoMantenimiento + " ]";
    }

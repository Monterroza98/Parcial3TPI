...
@NamedQueries({
    ...
    , @NamedQuery(name = "Diagnostico.findByNombreLike", query = "SELECT a FROM Diagnostico a WHERE LOWER(a.nombre) LIKE CONCAT('%',LOWER(:name),'%')")
...
public class Diagnostico implements Serializable {
    ...
    public String toString() {
        return "sv.uesocc.edu.ingenieria.tpi135_2018.mantto.Diagnostico[ idDiagnostico=" + idDiagnostico + " ]";
    }

...
@NamedQueries({
    ...
    , @NamedQuery(name = "TipoResponsable.findByNombreLike", query = "SELECT a FROM TipoResponsable a WHERE LOWER(a.nombre) LIKE CONCAT('%',LOWER(:name),'%')")
...
public class TipoResponsable implements Serializable {
    ...
    public String toString() {
        return "sv.uesocc.edu.ingenieria.tpi135_2018.mantto.TipoResponsable[ idTipoResponsable=" + idTipoResponsable + " ]";
    }

...
@NamedQueries({
    ...
    , @NamedQuery(name = "TipoParte.findByNombreLike", query = "SELECT a FROM TipoParte a WHERE LOWER(a.nombre) LIKE CONCAT('%',LOWER(:name),'%')")
...
public class TipoParte implements Serializable {
    ...
    public String toString() {
        return "sv.uesocc.edu.ingenieria.tpi135_2018.mantto.TipoParte[ idTipoParte=" + idTipoParte + " ]";
    }

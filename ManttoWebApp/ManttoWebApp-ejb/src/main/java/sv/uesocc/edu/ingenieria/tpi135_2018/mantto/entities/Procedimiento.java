...
@NamedQueries({
    ...
    , @NamedQuery(name = "Procedimiento.findByNombreLike", query = "SELECT a FROM Procedimiento a WHERE LOWER(a.nombre) LIKE CONCAT('%',LOWER(:name),'%')")
...
public class Procedimiento implements Serializable {
    ...
    public String toString() {
        return "sv.uesocc.edu.ingenieria.tpi135_2018.mantto.Procedimiento[ idProcedimiento=" + idProcedimiento + " ]";
    }
